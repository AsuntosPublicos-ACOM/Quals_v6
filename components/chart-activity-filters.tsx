...
export interface ChartActivityFilterState {
  dateFrom?: Date
  dateTo?: Date
  sectors: string[]
  partidos: string[]
...
interface ChartActivityFiltersProps {
  congresistas: Congresista[]
  onFiltersChange: (filters: ChartActivityFilterState) => void
}

export function ChartActivityFilters({ congresistas, onFiltersChange }: ChartActivityFiltersProps) {
  ...
  const legisladores = useMemo(() => 
    congresistas.map(c => ({ id: c.id, label: c.nombre }))
  , [congresistas])
  ...
  return (
    <div className="mb-6 border-b border-border pb-4">
      <button
        ...
        className="flex items-center justify-between w-full hover:opacity-75 transition-opacity mb-4"
      >
